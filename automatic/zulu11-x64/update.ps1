...
$jrerelease = 'https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=11&bundle_type=jre&features=&ext=zip&os=windows&arch=x86&hw_bitness=64'
$jdkfxrelease = 'https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=11&bundle_type=jdk&features=fx&ext=zip&os=windows&arch=x86&hw_bitness=64'
$jrefxrelease = 'https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=11&bundle_type=jre&features=fx&ext=zip&os=windows&arch=x86&hw_bitness=64'
