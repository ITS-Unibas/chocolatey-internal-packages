...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/Lexikos/AutoHotkey_L/releases/download/v1.1.34.02/AutoHotkey_1.1.34.02_setup.exe'
  silentArgs     = "/S /D=C:\Program Files\AutoHotkey"
  softwareName   = 'AutoHotkey*'
  checksum       = 'b0943f704ffc3830b8b900408b94e7a27434602dd34e9a831f81730bee4631a2'
