...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://github.com/audacity/audacity/releases/download/Audacity-3.0.5/audacity-win-3.0.5-64bit.exe'
  #OTHERS
  ...
  checksum       = 'de2fed286a819090ec416c02a0593f586a4527ab145c81c0ce108e0d7fc79bee'
