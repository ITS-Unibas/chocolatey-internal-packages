...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://github.com/audacity/audacity/releases/download/Audacity-3.2.5/audacity-win-3.2.5-x64.exe'
  #OTHERS
  ...
  checksum       = 'a0a34facbcc28dbe0b6905b29f6aa17353d40383214414e5693d4640f5e4527d'
