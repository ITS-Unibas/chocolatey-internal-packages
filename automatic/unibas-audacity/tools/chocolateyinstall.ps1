...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://github.com/audacity/audacity/releases/download/Audacity-3.2.0/audacity-win-3.2.0-64bit.exe'
  #OTHERS
  ...
  checksum       = 'e929635d3cbaf8c158ea6440157d305cd09baf8d6f7a7cf7f9a873ebf144e727'
