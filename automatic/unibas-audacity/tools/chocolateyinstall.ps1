...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://github.com/audacity/audacity/releases/download/Audacity-3.3.0/audacity-win-3.3.0-x64.exe'
  #OTHERS
  ...
  checksum       = '6d6153ff44859541fdf9cec487a525a4b0215b2f991af415bf623eff36dbd541'
