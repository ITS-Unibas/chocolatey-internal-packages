...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://github.com/audacity/audacity/releases/download/Audacity-3.2.3/audacity-win-3.2.3-x64.exe'
  #OTHERS
  ...
  checksum       = 'd0a925c8fe0589a8f0a0d0fe9b1f14f380ad0522d1ff33653f499ae389e7951a'
