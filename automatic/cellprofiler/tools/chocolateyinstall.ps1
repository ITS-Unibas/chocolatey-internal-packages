...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://cellprofiler-releases.s3.amazonaws.com/CellProfiler-Windows-4.0.3.exe'
  #file         = $fileLocation
  ...
  checksum       = 'bd6714baa428acace3a4fd9066045f2a4fbf78d2df6b6bca96b9cad406f6d9cf'
