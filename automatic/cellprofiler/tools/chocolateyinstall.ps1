...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://cellprofiler-releases.s3.amazonaws.com/CellProfiler-Windows-4.0.1.exe'
  #file         = $fileLocation
  ...
  checksum       = 'a231b119603fce7ff9aa62425fffc97db258b38fc761af1647d1d9b01cbed679'
