...
$releases = 'https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=11&bundle_type=jdk&features=&ext=msi&os=windows&arch=x86&hw_bitness=32'
$jrerelease = 'https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=11&bundle_type=jre&features=&ext=zip&os=windows&arch=x86&hw_bitness=32'
$jdkfxrelease = 'https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=11&bundle_type=jdk&features=fx&ext=zip&os=windows&arch=x86&hw_bitness=32'
$jrefxrelease = 'https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=11&bundle_type=jre&features=fx&ext=zip&os=windows&arch=x86&hw_bitness=32'
