...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = 'https://ardownload2.adobe.com/pub/adobe/reader/win/AcrobatDC/2200320258/AcroRdrDC2200320258_MUI.exe'
  checksum       = '3330daa49b542f83f20b3024b2a676c481f99b18168f99f90f4e4df015e2c995'
  checksumType   = 'sha256'
